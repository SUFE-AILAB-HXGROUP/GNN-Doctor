...
def train_attack(infer_data, labels, attack_infer_data, attack_labels, attack_model, attack_criterion, attack_optimizer, batch_size,train_mode = 0):
...
def test_attack(infer_data, labels, attack_infer_data, attack_labels, attack_model, attack_criterion, batch_size,train_mode = 0):
    attack_model.eval()
...
def nn_attack(train_member_pred,train_member_label,train_nonmember_pred,train_nonmember_label,test_member_pred,test_member_label,test_nonmember_pred,test_nonmember_label, attack_epochs=150, batch_size=512,num_class=100,train_mode = 0):
    """
    ...
    for epoch in range(0, attack_epochs):
        ...
        train_loss, train_attack_acc = train_attack(train_member_pred_tensor, train_member_label_tensor, train_nonmember_pred_tensor, train_nonmember_label_tensor, attack_model, attack_criterion, attack_optimizer, batch_size, train_mode)
        test_loss, test_attack_acc, mem, nonmem = test_attack(test_member_pred_tensor, test_member_label_tensor, test_nonmember_pred_tensor, test_nonmember_label_tensor, attack_model, attack_criterion, batch_size, train_mode)
...
def system_attack(train_member_pred,train_member_label,test_member_pred,test_member_label,train_nonmember_pred,train_nonmember_label,test_nonmember_pred,test_nonmember_label, num_class=100, attack_epochs=150, batch_size=512):
    ...
    nn_acc,_ = nn_attack(train_member_pred,train_member_label,train_nonmember_pred,train_nonmember_label,test_member_pred,test_member_label,test_nonmember_pred,test_nonmember_label, attack_epochs=150, batch_size=512,num_class=100)
